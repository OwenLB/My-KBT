	...
	<!------------------------------CORPS----------------------------------->
		<div id="article">		<!-- contenu de la page -->
			...
			<div style="text-align:justify">	
				...
				<div id="avatar">
					<?php
					if(!empty($resultat['avatar'])) //si la variable de l'avatar existe
					{
					?>
						  <img height="160" width="160" src="Utilisateurs/avatars/<?php echo $resultat['avatar'] ?>"> <!-- on l'affiche -->
					<?php	
					}
					?>
				</div>
				...
				<div id="information">
					...
					Prenom : <?php  echo $resultat['Prenom'] ?> </br></br></br> <!-- simple affichage de variable -->
					...
					Etudes supérieures : <?php  echo $resultat['sup'] ?> </br></br></br>
